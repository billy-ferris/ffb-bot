...
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/d8506396005d48d1a52dee114f2c05ae)](https://www.codacy.com/app/dtcarls/ffb-bot?utm_source=github.com&utm_medium=referral&utm_content=dtcarls/ffb-bot&utm_campaign=Badge_Grade)
...
Unfortunately to do auto deploys of the latest version you need admin access to the repository on git. You can check for updates on the github page (https://github.com/dtcarls/ffb-bot/commits/master) and click the deploy button again; however, this will deploy a new instance and the variables will need to be edited again.
...
```bash
git clone https://github.com/dtcarls/ffb-bot
...
>>> export LEAGUE_YEAR=[enter league year]
>>> cd ffb-bot
>>> python3 ffb-bot/ffb-bot.py
```

### Running the tests

Automated tests for this package are included in the `tests` directory. After installation,
you can run these tests by changing the directory to the `ffb-bot` directory and running the following:
